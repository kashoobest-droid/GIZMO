...
<head>
    ...
    <title>Create Offer - GIZMO Store</title>
    <style>
        :root {
            --bg-primary: #ffffff;
            --bg-secondary: #f5f5f5;
...
<body>
    ...
    <div class="container">
        <h3><i class="fas fa-plus-circle"></i> Create Offer</h3>
        ...
        <form action="{{ route('offer.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input name="offer_name" class="form-control" value="{{ old('offer_name') }}" placeholder="e.g., Special Bundle Offer">
            </div>

            <div class="mb-3">
                <label class="form-label"><i class="fas fa-gift me-2" style="color: #DC143C;"></i>Gift Name <span class="text-danger">*</span></label>
                <input name="gift_name" class="form-control" value="{{ old('gift_name') }}" placeholder="e.g., Free Shipping" required>
            </div>

            <div class="mb-3">
                <label class="form-label"><i class="fas fa-file-alt me-2" style="color: #DC143C;"></i>Description</label>
                <textarea name="description" class="form-control" rows="3" placeholder="Describe the offer details...">{{ old('description') }}</textarea>
            </div>

            <div class="mb-3">
                <label class="form-label"><i class="fas fa-image me-2" style="color: #DC143C;"></i>Image</label>
                <input type="file" name="image" class="form-control" accept="image/*">
                <div class="form-text">Upload an image for this offer (optional)</div>
            </div>
